/**
 * i18n.js - Translation engine for WellBeingBar
...
const I18n = (() => {
  ...
  async function init() {
    _lang = localStorage.getItem('wb-lang') || 'en';
  ...
  function getPracticeName(practice) {
    if (practice.name[_lang]) return practice.name[_lang];
    return practice.name.en || practice.id;
  }
  ...
  async function setLang(lang) {
    ...
    _applyTranslations();
    _updateSwitcher();
    document.dispatchEvent(new CustomEvent('wb-lang-change', { detail: { lang: _lang } }));
  }
  ...
  return { init, t, getLang, getManifest, getPracticeName, setLang };
})();
